        ...
        \begin{tikzpicture}[scale=0.85, transform shape]
        	\only<1>{
        		\foreach \x/\val in {0/8,1/27,2/2021,3/110,4/20}{
        			\node[draw,rectangle, fill=black!10, minimum size =1cm] (c) at (\x,0) {\val};
        		}
        	}
        	\only<2>{
...
\frame
{
	\frametitle{AtCoder Beginner Contest 154 C - Distinct or Not}
	...
	\begin{block}{Algorithm}
		In \textbf{combine} process of merge sort, we could check whether $\texttt{*itr} == \texttt{*jtr}$.
	\end{block}
}
...
\frame{
	...
	\begin{center}
        \begin{tikzpicture}[scale=0.85, transform shape]
        	\only<1>{
        		\foreach \x/\val/\col in {0/8/black,1/27/black,2/2021/black,3/110/black,4/20/nthu}{
        			\node[draw=\col,rectangle, fill=\col!10, minimum size =1cm] (c) at (\x,0) {\val};
        		}
        	}
        	\only<2>{
        		\foreach \x/\val/\col in {0/8/black,2/20/nthu,4/27/black,5/2021/black,6/110/nthu}{
        			\node[draw=\col,rectangle, fill=\col!10, minimum size =1cm] (c) at (\x,0) {\val};
        		}
        	}
        	\only<3>{
        		\foreach \x/\val/\col in {0/8/black,3/20/nthu,6/27/black,8/110/nthu,10/2021/black}{
        			\node[draw=\col,rectangle, fill=\col!10, minimum size =1cm] (c) at (\x,0) {\val};
        		}
        	}
        	\only<4>{
        		\foreach \x/\val/\col in {0/8/black,2/20/nthu,4/27/black,5/110/black,6/2021/black}{
        			\node[draw=\col,rectangle, fill=\col!10, minimum size =1cm] (c) at (\x,0) {\val};
        		}
        	}
        	\only<5>{
        		\foreach \x/\val/\col in {0/8/black,1/20/black,2/27/black,3/110/black,4/2021/black}{
        			\node[draw=\col,rectangle, fill=\col!10, minimum size =1cm] (c) at (\x,0) {\val};
        		}
        	}
        \end{tikzpicture}
